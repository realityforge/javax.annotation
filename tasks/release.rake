...
### [v#{ENV['PRODUCT_VERSION']}](https://github.com/realityforge/javax.annotation/tree/v#{ENV['PRODUCT_VERSION']}) (#{ENV['RELEASE_DATE']})
[Full Changelog](https://github.com/realityforge/javax.annotation/compare/#{from}...v#{ENV['PRODUCT_VERSION']})
HEADER
